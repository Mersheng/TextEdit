...
import 'package:text_editor/src/widget/font_option_color.dart';
import 'package:text_editor/src/widget/font_option_family.dart';
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      child: Center(
                        child: TextField(
                          controller: TextEditingController()..selection= TextSelection(baseOffset:_textStyleModel.text.length , extentOffset:_textStyleModel.text.length)
